...
namespace UserAuthBlog.Migrations
{
    ...
    [Migration("20210325135343_RemovePostListFromTags")]
    partial class RemovePostListFromTags
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UserAuthBlog.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UserAuthBlog.Data.Comment", b =>
                {
                    ...
                    b.HasOne("UserAuthBlog.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
